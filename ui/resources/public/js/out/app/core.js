...
re_frame.core.reg_event_fx.call(null,new cljs.core.Keyword("app.core","initialize","app.core/initialize",1664650061),(function (p__25607,_){
...
var db = cljs.core.get.call(null,map__25608__$1,new cljs.core.Keyword(null,"db","db",993250759));
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"db","db",993250759),cljs.core.assoc.call(null,cljs.core.assoc_in.call(null,db,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"xhr","xhr",-177710851),new cljs.core.Keyword(null,"config","config",994861415),new cljs.core.Keyword(null,"base-url","base-url",9540398)], null),(function (){var or__4131__auto__ = window.baseURL;
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
return "http://localhost:9090";
}
})()),new cljs.core.Keyword("route-map","routes","route-map/routes",-450527158),app.routes.routes),new cljs.core.Keyword("route-map","start","route-map/start",-726109997),cljs.core.PersistentArrayMap.EMPTY], null);
}));
