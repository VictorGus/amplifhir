...
var G__12055 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$zframes$redirect_SLASH_redirect,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$uri,"/patient/create"], null)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__12055) : re_frame.core.dispatch.call(null,G__12055));
})], null),"+ \u0421\u043E\u0437\u0434\u0430\u0442\u044C"], null)], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div$patient_DASH_grid$w_DASH_100$ml_DASH_1,(function (){var iter__4523__auto__ = (function app$patient$view$iter__12056(s__12057){
return (new cljs.core.LazySeq(null,(function (){
var s__12057__$1 = s__12057;
while(true){
var temp__5720__auto__ = cljs.core.seq(s__12057__$1);
if(temp__5720__auto__){
var s__12057__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(s__12057__$2)){
var c__4521__auto__ = cljs.core.chunk_first(s__12057__$2);
var size__4522__auto__ = cljs.core.count(c__4521__auto__);
var b__12059 = cljs.core.chunk_buffer(size__4522__auto__);
if((function (){var i__12058 = (0);
while(true){
if((i__12058 < size__4522__auto__)){
var item = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4521__auto__,i__12058);
cljs.core.chunk_append(b__12059,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [app.patient.view.item_view,item], null));

var G__12060 = (i__12058 + (1));
i__12058 = G__12060;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__12059),app$patient$view$iter__12056(cljs.core.chunk_rest(s__12057__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__12059),null);
}
} else {
var item = cljs.core.first(s__12057__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [app.patient.view.item_view,item], null),app$patient$view$iter__12056(cljs.core.rest(s__12057__$2)));
}
} else {
return null;
}
...
})()], null)], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$p$patient_DASH_name,cljs.core.cst$kw$name.cljs$core$IFn$_invoke$arity$1(data)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$p$text_DASH_muted$mb_DASH_0,cljs.core.cst$kw$birthDate.cljs$core$IFn$_invoke$arity$1(data)], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$p$edit_DASH_button$mt_DASH_2$mr_DASH_2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$i$fas$fa_DASH_edit,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$on_DASH_click,(function (){
var G__12062 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$zframes$redirect_SLASH_redirect,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$uri,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.last(clojure.string.split.cljs$core$IFn$_invoke$arity$2(window.location.href,/#/))),"/edit"].join('')], null)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__12062) : re_frame.core.dispatch.call(null,G__12062));
})], null)], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$p$delete_DASH_button$mt_DASH_2$mr_DASH_2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$i$fas$fa_DASH_trash_DASH_alt,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$on_DASH_click,(function (){
var G__12063 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$app$patient$model_SLASH_delete_DASH_patient,cljs.core.cst$kw$zframes$redirect_SLASH_redirect], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__12063) : re_frame.core.dispatch.call(null,G__12063));
})], null)], null)], null)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div$card,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div$card_DASH_header$info_DASH_header,"\u0418\u043D\u0444\u043E\u0440\u043C\u0430\u0446\u0438\u044F \u043E \u043F\u0430\u0446\u0438\u0435\u043D\u0442\u0435"], null),(cljs.core.truth_(cljs.core.cst$kw$address.cljs$core$IFn$_invoke$arity$1(data))?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div$card_DASH_body,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$h5$card_DASH_title,"\u0410\u0434\u0440\u0435\u0441"], null),(function (){var iter__4523__auto__ = (function app$patient$view$patient_card_$_iter__12064(s__12065){
return (new cljs.core.LazySeq(null,(function (){
var s__12065__$1 = s__12065;
while(true){
var temp__5720__auto__ = cljs.core.seq(s__12065__$1);
if(temp__5720__auto__){
var s__12065__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(s__12065__$2)){
var c__4521__auto__ = cljs.core.chunk_first(s__12065__$2);
var size__4522__auto__ = cljs.core.count(c__4521__auto__);
var b__12067 = cljs.core.chunk_buffer(size__4522__auto__);
if((function (){var i__12066 = (0);
while(true){
if((i__12066 < size__4522__auto__)){
var item = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4521__auto__,i__12066);
cljs.core.chunk_append(b__12067,new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div$d_DASH_flex$flex_DASH_wrap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div$info_DASH_item,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$span$text_DASH_muted,"\u0421\u0442\u0440\u0430\u043D\u0430: "], null),cljs.core.cst$kw$country.cljs$core$IFn$_invoke$arity$1(item)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div$info_DASH_item,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$span$text_DASH_muted,"\u0413\u043E\u0440\u043E\u0434: "], null),cljs.core.cst$kw$city.cljs$core$IFn$_invoke$arity$1(item)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div$info_DASH_item,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$span$text_DASH_muted,"\u041F\u043E\u0447\u0442\u043E\u0432\u044B\u0439 \u0438\u043D\u0434\u0435\u043A\u0441: "], null),cljs.core.cst$kw$postalCode.cljs$core$IFn$_invoke$arity$1(item)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div$info_DASH_item,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$span$text_DASH_muted,"\u0420\u0430\u0439\u043E\u043D: "], null),cljs.core.cst$kw$state.cljs$core$IFn$_invoke$arity$1(item)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div$info_DASH_item,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$span$text_DASH_muted,"\u0423\u043B\u0438\u0446\u0430: "], null),cljs.core.cst$kw$line.cljs$core$IFn$_invoke$arity$1(item)], null)], null));

var G__12069 = (i__12066 + (1));
i__12066 = G__12069;
continue;
} else {
return true;
