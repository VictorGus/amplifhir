...
return [(function (){var pred__29238 = cljs.core.instance_QMARK_;
var expr__29239 = reactive_val;
if(cljs.core.truth_(pred__29238.call(null,reagent.ratom.RAtom,expr__29239))){
return "ra";
} else {
if(cljs.core.truth_(pred__29238.call(null,reagent.ratom.RCursor,expr__29239))){
return "rc";
} else {
if(cljs.core.truth_(pred__29238.call(null,reagent.ratom.Reaction,expr__29239))){
return "rx";
} else {
if(cljs.core.truth_(pred__29238.call(null,reagent.ratom.Track,expr__29239))){
return "tr";
} else {
return "other";
}
