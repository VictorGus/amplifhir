...
return [(function (){var pred__5991 = cljs.core.instance_QMARK_;
var expr__5992 = reactive_val;
if(cljs.core.truth_((pred__5991.cljs$core$IFn$_invoke$arity$2 ? pred__5991.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__5992) : pred__5991.call(null,reagent.ratom.RAtom,expr__5992)))){
return "ra";
} else {
if(cljs.core.truth_((pred__5991.cljs$core$IFn$_invoke$arity$2 ? pred__5991.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__5992) : pred__5991.call(null,reagent.ratom.RCursor,expr__5992)))){
return "rc";
} else {
if(cljs.core.truth_((pred__5991.cljs$core$IFn$_invoke$arity$2 ? pred__5991.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__5992) : pred__5991.call(null,reagent.ratom.Reaction,expr__5992)))){
return "rx";
} else {
if(cljs.core.truth_((pred__5991.cljs$core$IFn$_invoke$arity$2 ? pred__5991.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__5992) : pred__5991.call(null,reagent.ratom.Track,expr__5992)))){
return "tr";
} else {
return "other";
}
