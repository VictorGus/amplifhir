...
if((c === "\n")){
var G__33565 = escape_QMARK_;
var G__33566 = rewrite_clj.parser.string.flush_into.call(null,lines,buf);
escape_QMARK_ = G__33565;
lines = G__33566;
continue;
} else {
buf.append(c);

var G__33567 = (((!(escape_QMARK_))) && ((c === "\\")));
var G__33568 = lines;
escape_QMARK_ = G__33567;
lines = G__33568;
continue;
