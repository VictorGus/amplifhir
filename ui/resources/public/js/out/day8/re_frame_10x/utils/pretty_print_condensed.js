...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.subs.call(null,string,(0),(function (){var G__41619 = per_side_budget;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__41616__$1)].join('')));
...
var G__41626 = clojure.string.replace.call(null,s,match,trunc_prefix);
var G__41627 = limit;
var G__41628 = match;
var G__41629 = trunc_prefix;
s = G__41626;
limit = G__41627;
match = G__41628;
trunc_prefix = G__41629;
continue;
}
}
break;
...
var prefix = (function (){var G__41630 = ((kw_QMARK_)?":":"");
if(cljs.core.truth_(the_ns)){
return [G__41630,"\u2026/"].join('');
} else {
return G__41630;
}
})();
...
var vec__41632 = day8.re_frame_10x.utils.pretty_print_condensed.edges.call(null,coll);
var left = cljs.core.nth.call(null,vec__41632,(0),null);
var right = cljs.core.nth.call(null,vec__41632,(1),null);
...
var or__4131__auto__ = (function (){var G__41639 = form.name;
if((G__41639 == null)){
return null;
} else {
return clojure.string.replace.call(null,G__41639,/(^.*\$)(.*)/,"$2");
}
})();
...
var seq__41641 = cljs.core.seq.call(null,cljs.core.next.call(null,objs));
var chunk__41642 = null;
var count__41643 = (0);
var i__41644 = (0);
while(true){
if((i__41644 < count__41643)){
var obj = cljs.core._nth.call(null,chunk__41642,i__41644);
cljs.core._write.call(null,writer," ");

day8.re_frame_10x.utils.pretty_print_condensed.pr_writer.call(null,obj,writer,opts);


var G__41645 = seq__41641;
var G__41646 = chunk__41642;
var G__41647 = count__41643;
var G__41648 = (i__41644 + (1));
seq__41641 = G__41645;
chunk__41642 = G__41646;
count__41643 = G__41647;
i__41644 = G__41648;
continue;
} else {
var temp__5720__auto__ = cljs.core.seq.call(null,seq__41641);
if(temp__5720__auto__){
var seq__41641__$1 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__41641__$1)){
var c__4550__auto__ = cljs.core.chunk_first.call(null,seq__41641__$1);
var G__41649 = cljs.core.chunk_rest.call(null,seq__41641__$1);
var G__41650 = c__4550__auto__;
var G__41651 = cljs.core.count.call(null,c__4550__auto__);
var G__41652 = (0);
seq__41641 = G__41649;
chunk__41642 = G__41650;
count__41643 = G__41651;
i__41644 = G__41652;
continue;
} else {
var obj = cljs.core.first.call(null,seq__41641__$1);
cljs.core._write.call(null,writer," ");

day8.re_frame_10x.utils.pretty_print_condensed.pr_writer.call(null,obj,writer,opts);


var G__41653 = cljs.core.next.call(null,seq__41641__$1);
var G__41654 = null;
var G__41655 = (0);
var G__41656 = (0);
seq__41641 = G__41653;
chunk__41642 = G__41654;
count__41643 = G__41655;
i__41644 = G__41656;
continue;
}
} else {
...
/** @this {Function} */
day8.re_frame_10x.utils.pretty_print_condensed.pr_str_truncated.cljs$lang$applyTo = (function (seq41657){
var G__41658 = cljs.core.first.call(null,seq41657);
var seq41657__$1 = cljs.core.next.call(null,seq41657);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41658,seq41657__$1);
});
