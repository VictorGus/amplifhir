...
return cljs.core.filter.call(null,(function (p1__40495_SHARP_){
return (((beginning <= new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__40495_SHARP_))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__40495_SHARP_) <= ending)));
}));
});
...
var G__40496 = new cljs.core.Keyword(null,"op-type","op-type",-1636141668).cljs$core$IFn$_invoke$arity$1(trace);
...
return cljs.core._EQ_.call(null,new cljs.core.Keyword("sub","dispose","sub/dispose",365440536),p1__40498_SHARP_);
});})(and__4120__auto__))
...
return cljs.core.assoc_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"operation","operation",-1267664310).cljs$core$IFn$_invoke$arity$1(trace),new cljs.core.Keyword(null,"layer","layer",-1601820589)], null),(cljs.core.truth_(cljs.core.some.call(null,(function (p1__40499_SHARP_){
return cljs.core._EQ_.call(null,app_db_id,p1__40499_SHARP_);
...
})),cljs.core.map.call(null,(function (p__40500){
...
var new_state = (function (){var G__40504 = new cljs.core.Keyword(null,"op-type","op-type",-1636141668).cljs$core$IFn$_invoke$arity$1(trace);
...
break;
case "sub/run":
return cljs.core.update.call(null,state,reaction_id,((function (G__40504,G__40504__$1,tags,reaction_id,state){
...
});})(G__40504,G__40504__$1,tags,reaction_id,state))
);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__40504__$1)].join('')));
...
return (function (all_state,p__40505){
var vec__40506 = p__40505;
var sub_id = cljs.core.nth.call(null,vec__40506,(0),null);
var sub_state = cljs.core.nth.call(null,vec__40506,(1),null);
