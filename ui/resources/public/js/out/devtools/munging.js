...
var o29506 = temp__5718__auto__;
var temp__5718__auto____$1 = (o29506["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o29507 = temp__5718__auto____$1;
return (o29507["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__15449__auto__ = f;
return (o__15449__auto__["toString"]).call(o__15449__auto__);
} else {
return "";
}
}catch (e29508){var _ = e29508;
return "";
}});
...
try{var o__15449__auto___29510 = t;
(o__15449__auto___29510["cljs$lang$ctorPrWriter"]).call(o__15449__auto___29510,t,writer);
}catch (e29509){var __29511 = e29509;
}
...
var char_code = (function (){var o__15449__auto__ = (new String(char$));
return (o__15449__auto__["charCodeAt"]).call(o__15449__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__15449__auto__ = String;
return (o__15449__auto__["fromCharCode"]).call(o__15449__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__29512 = num_code;
switch (G__29512) {
case (1):
return (185);
...
var o__15449__auto__ = String;
return (o__15449__auto__["fromCharCode"]).call(o__15449__auto__,superscript_code);
});
/**
...
}catch (e29514){var _e__15456__auto__ = e29514;
return false;
}})())){
...
var vec__29515 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__29515,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o29518 = temp__5718__auto__;
var temp__5718__auto____$1 = (o29518["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o29519 = temp__5718__auto____$1;
return (o29519["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___29526 = arguments.length;
var i__4731__auto___29527 = (0);
while(true){
if((i__4731__auto___29527 < len__4730__auto___29526)){
args__4736__auto__.push((arguments[i__4731__auto___29527]));

var G__29528 = (i__4731__auto___29527 + (1));
i__4731__auto___29527 = G__29528;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__29522){
var vec__29523 = p__29522;
var ns_detector = cljs.core.nth.call(null,vec__29523,(0),null);
...
var G__29529 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__29530 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__29529;
remaining_tokens = G__29530;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq29520){
var G__29521 = cljs.core.first.call(null,seq29520);
var seq29520__$1 = cljs.core.next.call(null,seq29520);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29521,seq29520__$1);
});
...
var vec__29534 = cljs.core.split_with.call(null,(function (p1__29533_SHARP_){
return cljs.core.not_EQ_.call(null,p1__29533_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__29534,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__29534,(1),null);
...
var vec__29540 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__29540,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__29540,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__29543 = cljs.core.rest.call(null,remaining_tokens);
var G__29544 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__29543;
name_tokens = G__29544;
continue;
} else {
...
var vec__29547 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__29547,(0),null);
var arity = cljs.core.nth.call(null,vec__29547,(1),null);
var vec__29550 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__29550,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__29550,(1),null);
var vec__29553 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__29553,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__29553,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__29553,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__29553,(3),null);
...
var vec__29559 = result;
var munged_ns = cljs.core.nth.call(null,vec__29559,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__29559,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__29559,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__29559,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__29559,(4),null);
var arity = cljs.core.nth.call(null,vec__29559,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__29563 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__29563,(0),null);
var args = cljs.core.nth.call(null,vec__29563,(1),null);
var vec__29566 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__29566,(0),null);
var name = cljs.core.nth.call(null,vec__29566,(1),null);
...
var G__29569 = (arity + (1));
var G__29570 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__29571){
var vec__29572 = p__29571;
var arity = cljs.core.nth.call(null,vec__29572,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__29572,(1),null);
...
return cljs.core.get.call(null,arities,p1__29575_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__29576_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__29579){
var vec__29580 = p__29579;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__29580,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq29577){
var G__29578 = cljs.core.first.call(null,seq29577);
var seq29577__$1 = cljs.core.next.call(null,seq29577);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29578,seq29577__$1);
});
...
var G__29586 = arg;
var G__29586__$1 = (((G__29586 instanceof cljs.core.Keyword))?G__29586.fqn:null);
switch (G__29586__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__29588__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__29588__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__29588__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__29588__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__29589 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__29589,(0),null);
var fn_name = cljs.core.nth.call(null,vec__29589,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__29589,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__29589,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__29589,(4),null);
var arity = cljs.core.nth.call(null,vec__29589,(5),null);
...
var o__15449__auto__ = f;
return (o__15449__auto__["getBasis"]).call(o__15449__auto__);
});
/**
...
}catch (e29593){var _e__15456__auto__ = e29593;
...
var G__29594 = (obj[cljs.core.first.call(null,path)]);
var G__29595 = cljs.core.rest.call(null,path);
obj = G__29594;
path = G__29595;
continue;
} else {
...
return (function (accum,p__29596){
var vec__29597 = p__29596;
var bit = cljs.core.nth.call(null,vec__29597,(0),null);
var protocol = cljs.core.nth.call(null,vec__29597,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__29600){
var vec__29601 = p__29600;
var ns = cljs.core.nth.call(null,vec__29601,(0),null);
var name = cljs.core.nth.call(null,vec__29601,(1),null);
var selector = cljs.core.nth.call(null,vec__29601,(2),null);
...
return (function (p__29605){
var vec__29606 = p__29605;
var munged_name = cljs.core.nth.call(null,vec__29606,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__29606,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__29606,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__29604_SHARP_){
return (obj[cljs.core.first.call(null,p1__29604_SHARP_)]);
});})(name,sorted_matches,vec__29606,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
