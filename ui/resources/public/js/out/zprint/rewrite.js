...
var G__37016 = rewrite_clj.zip.next.call(null,n);
loc = G__37016;
continue;
} else {
var G__37017 = rewrite_clj.zip.next.call(null,loc);
loc = G__37017;
continue;
}
} else {
var G__37018 = rewrite_clj.zip.next.call(null,loc);
loc = G__37018;
continue;
}
}
...
return rewrite_clj.zip.replace.call(null,zloc,rewrite_clj.zip.root.call(null,zprint.rewrite.prewalk_subtree.call(null,p_QMARK_,f,(function (){var G__37019 = zloc;
var G__37019__$1 = (((G__37019 == null))?null:rewrite_clj.zip.node.call(null,G__37019));
if((G__37019__$1 == null)){
return null;
} else {
return zprint.zutil.edn_STAR_.call(null,G__37019__$1);
}
})())));
});
/**
...
var G__37020 = rewrite_clj.zip.down.call(null,nloc);
nloc = G__37020;
continue;
}
break;
...
var G__37021 = rewrite_clj.zip.right.call(null,nloc);
var G__37022 = cljs.core.conj.call(null,out,nloc);
nloc = G__37021;
out = G__37022;
continue;
} else {
...
var G__37023 = rewrite_clj.zip.right.call(null,replaced_loc);
var G__37024 = cljs.core.next.call(null,new_loc);
var G__37025 = replaced_loc;
nloc = G__37023;
new_loc = G__37024;
last_loc = G__37025;
continue;
...
var new_dep = zprint.rewrite.prewalk.call(null,zloc,(function (p1__37026_SHARP_){
return ((cljs.core._EQ_.call(null,rewrite_clj.zip.tag.call(null,p1__37026_SHARP_),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.call(null,rewrite_clj.zip.sexpr.call(null,p1__37026_SHARP_),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
