...
return (function day8$re_frame_10x$view$history$render_$_iter__41723(s__41724){
return (new cljs.core.LazySeq(null,((function (all_events,current_id){
return (function (){
var s__41724__$1 = s__41724;
while(true){
var temp__5720__auto__ = cljs.core.seq.call(null,s__41724__$1);
if(temp__5720__auto__){
var s__41724__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__41724__$2)){
var c__4521__auto__ = cljs.core.chunk_first.call(null,s__41724__$2);
var size__4522__auto__ = cljs.core.count.call(null,c__4521__auto__);
var b__41726 = cljs.core.chunk_buffer.call(null,size__4522__auto__);
if((function (){var i__41725 = (0);
while(true){
if((i__41725 < size__4522__auto__)){
var vec__41727 = cljs.core._nth.call(null,c__4521__auto__,i__41725);
var id = cljs.core.nth.call(null,vec__41727,(0),null);
var event = cljs.core.nth.call(null,vec__41727,(1),null);
if(cljs.core.truth_(cljs.core.not_empty.call(null,event))){
cljs.core.chunk_append.call(null,b__41726,cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.view.history.history_item,event,id,current_id], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)));

var G__41733 = (i__41725 + (1));
i__41725 = G__41733;
continue;
} else {
var G__41734 = (i__41725 + (1));
i__41725 = G__41734;
continue;
}
} else {
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__41726),day8$re_frame_10x$view$history$render_$_iter__41723.call(null,cljs.core.chunk_rest.call(null,s__41724__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__41726),null);
}
} else {
var vec__41730 = cljs.core.first.call(null,s__41724__$2);
var id = cljs.core.nth.call(null,vec__41730,(0),null);
var event = cljs.core.nth.call(null,vec__41730,(1),null);
if(cljs.core.truth_(cljs.core.not_empty.call(null,event))){
return cljs.core.cons.call(null,cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.view.history.history_item,event,id,current_id], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)),day8$re_frame_10x$view$history$render_$_iter__41723.call(null,cljs.core.rest.call(null,s__41724__$2)));
} else {
var G__41735 = cljs.core.rest.call(null,s__41724__$2);
s__41724__$1 = G__41735;
continue;
}
}
} else {
