...
var len__4730__auto___36539 = arguments.length;
var i__4731__auto___36540 = (0);
while(true){
if((i__4731__auto___36540 < len__4730__auto___36539)){
args__4736__auto__.push((arguments[i__4731__auto___36540]));

var G__36541 = (i__4731__auto___36540 + (1));
i__4731__auto___36540 = G__36541;
continue;
} else {
}
break;
...
return clojure.zip.edit.call(null,zloc,rewrite_clj.zip.editz.edit_node,(function (p1__36535_SHARP_){
return cljs.core.apply.call(null,f,p1__36535_SHARP_,args);
}));
});
...
/** @this {Function} */
rewrite_clj.zip.editz.edit.cljs$lang$applyTo = (function (seq36536){
var G__36537 = cljs.core.first.call(null,seq36536);
var seq36536__$1 = cljs.core.next.call(null,seq36536);
var G__36538 = cljs.core.first.call(null,seq36536__$1);
var seq36536__$2 = cljs.core.next.call(null,seq36536__$1);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__36537,G__36538,seq36536__$2);
});
...
var G__36544 = rewrite_clj.zip.base.tag.call(null,zloc);
var G__36544__$1 = (((G__36544 instanceof cljs.core.Keyword))?G__36544.fqn:null);
switch (G__36544__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token.call(null,zloc,((function (G__36544,G__36544__$1){
return (function (p1__36542_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__36542_SHARP_)].join('');
});})(G__36544,G__36544__$1))
);

break;
case "multi-line":
return rewrite_clj.zip.editz.edit_multi_line.call(null,zloc,((function (G__36544,G__36544__$1){
return (function (lines){
if(cljs.core.empty_QMARK_.call(null,lines)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [s], null);
} else {
return cljs.core.update_in.call(null,lines,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0)], null),((function (G__36544,G__36544__$1){
return (function (p1__36543_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__36543_SHARP_)].join('');
});})(G__36544,G__36544__$1))
);
}
});})(G__36544,G__36544__$1))
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__36544__$1)].join('')));

}
});
rewrite_clj.zip.editz.suffix = (function rewrite_clj$zip$editz$suffix(zloc,s){
var G__36547 = rewrite_clj.zip.base.tag.call(null,zloc);
var G__36547__$1 = (((G__36547 instanceof cljs.core.Keyword))?G__36547.fqn:null);
switch (G__36547__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token.call(null,zloc,((function (G__36547,G__36547__$1){
return (function (p1__36546_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__36546_SHARP_),cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join('');
});})(G__36547,G__36547__$1))
);

break;
case "multi-line":
return rewrite_clj.zip.editz.edit_multi_line.call(null,zloc,((function (G__36547,G__36547__$1){
return (function (lines){
if(cljs.core.empty_QMARK_.call(null,lines)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [s], null);
} else {
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__36547__$1)].join('')));
