...
var G__28959 = o;
goog.object.set(G__28959,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__28960__delegate = function (args){
...
while (G__28961__i < G__28961__a.length) {G__28961__a[G__28961__i] = arguments[G__28961__i + 0]; ++G__28961__i;}
  args = new cljs.core.IndexedSeq(G__28961__a,0,null);
} 
return G__28960__delegate.call(this,args);};
...
return G__28960__delegate(args);
});
...
var G__28963 = o;
goog.object.set(G__28963,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__28964__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
...
while (G__28965__i < G__28965__a.length) {G__28965__a[G__28965__i] = arguments[G__28965__i + 0]; ++G__28965__i;}
  args = new cljs.core.IndexedSeq(G__28965__a,0,null);
} 
...
var args = cljs.core.seq(arglist__28966);
...
var G__28967 = props;
var G__28967__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__28967,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__28967);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__28967__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__28967__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__28968 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__28968,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__28968;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__28969){
...
var on_write = cljs.core.get.call(null,map__28970__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__28970,map__28970__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__28970,map__28970__$1,on_write))
);
} else {
...
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__28972_SHARP_);
});})(v,value,on_change))
;
} else {
return null;
...
var vec__28975 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__28975,(0),null);
var id = cljs.core.nth.call(null,vec__28975,(1),null);
var className = cljs.core.nth.call(null,vec__28975,(2),null);
...
var temp__5724__auto___28979 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5724__auto___28979 == null)){
} else {
var key_28980 = temp__5724__auto___28979;
jsprops.key = key_28980;
}
...
var temp__5724__auto___28981 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5724__auto___28981 == null)){
} else {
var key_28982 = temp__5724__auto___28981;
jsprops.key = key_28982;
}
...
var temp__5724__auto___28983 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5724__auto___28983 == null)){
} else {
var key_28984 = temp__5724__auto___28983;
jsprops.key = key_28984;
}
...
var G__28986 = n;
if(cljs.core._EQ_.call(null,"",G__28986)){
return x;
} else {
if(cljs.core._EQ_.call(null,null,G__28986)){
return x;
} else {
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq28987){
var G__28988 = cljs.core.first.call(null,seq28987);
var seq28987__$1 = cljs.core.next.call(null,seq28987);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28988,seq28987__$1);
});
...
break;
default:
var G__28994 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__28994;
continue;
...
var ctx = ({});
var vec__28996 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__28996,(0),null);
var derefed = cljs.core.nth.call(null,vec__28996,(1),null);
...
var G__28999 = (cljs.core.count.call(null,argv) - first_child);
switch (G__28999) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__28999){
