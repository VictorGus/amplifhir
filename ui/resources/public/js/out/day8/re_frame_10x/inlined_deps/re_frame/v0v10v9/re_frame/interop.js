...
return [(function (){var pred__39400 = cljs.core.instance_QMARK_;
var expr__39401 = reactive_val;
if(cljs.core.truth_(pred__39400.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v8v1.reagent.ratom.RAtom,expr__39401))){
return "ra";
} else {
if(cljs.core.truth_(pred__39400.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v8v1.reagent.ratom.RCursor,expr__39401))){
return "rc";
} else {
if(cljs.core.truth_(pred__39400.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v8v1.reagent.ratom.Reaction,expr__39401))){
return "rx";
} else {
if(cljs.core.truth_(pred__39400.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v8v1.reagent.ratom.Track,expr__39401))){
return "tr";
} else {
return "other";
}
